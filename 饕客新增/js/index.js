...
$(function(){
    ...
    $("#super_citys>.provinces>ul>li").click(function(){
        ...
        $("#super_citys>.provinces>div").html($(this).children("span").html()+"<i class='fa fa-caret-down'></i>");
        var html2='<li><input type="hidden" value="0"><span>城市</span></li>';
        var index_s=$(this).children("input").val();
        if(sheng!==index_s){
            $("#super_citys>.city>div").html("城市"+"<i class='fa fa-caret-down'></i>");
            $("#super_citys>.city>.input1").val(0);
            $("#super_citys>.city>.input2").val(0);
            $("#super_citys>.area>div").html("地区"+"<i class='fa fa-caret-down'></i>");
            $("#super_citys>.area>.input1").val(0);
            $("#super_citys>.area>.input2").val(0);
            $("#super_citys>.area>ul").html('<li><input type="hidden" value="0"><span>地区</span></li>');
        }
        sheng=index_s;
        if(index_s==0){
            $("#super_citys>.provinces>.input2").val(0);
            $("#super_citys>.city>ul").html('<li><input type="hidden" value="0"><span>城市</span></li>');
            $("#super_citys>.city>.input1").val(0);
            $("#super_citys>.city>.input2").val(0);
            $("#super_citys>.area>ul").html('<li><input type="hidden" value="0"><span>地区</span></li>');
            $("#super_citys>.area>.input1").val(0);
    ...
    $("#super_citys>.city>ul").on("click","li",function(){
        ...
        $("#super_citys>.city>div").html($(this).children("span").html()+"<i class='fa fa-caret-down'></i>");
        var html3='<li><input type="hidden" value="0"><span>地区</span></li>';
    ...
    $("#super_citys>.area>ul").on("click","li",function(){
        ...
        $("#super_citys>.area>div").html($(this).children("span").html()+"<i class='fa fa-caret-down'></i>");
    });
    //点击显示框效果
    ...
    $("#super_citys>.provinces").click(function(e){
		$("#super>.state>ul").css("display","none");
		$("#super>.state").removeClass("shadow");
		var state=$(".state>.input1").val();
		if(state==0){
			alert("国家！");
			return;
		}
    ...
    $("#super_citys>.city").click(function(e){
		$("#super>.state>ul").css("display","none");
		$("#super>.provinces").removeClass("shadow");
		var provinces=$(".provinces>.input1").val();
		if(provinces==0){
			alert("省份！");
			return;
		}
    ...
    $("#super_citys>.area").click(function(e){
		$("#super>.state>ul").css("display","none");
		$("#super>.city").removeClass("shadow");
		var city=$(".city>.input1").val();
		if(city==0){
			alert("城市！");
			return;
		}
